...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 1, 0, 0),
  [16] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_line, 1, 0, 0),
  [18] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [20] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line, 2, 0, 0),
...
TS_PUBLIC const TSLanguage *tree_sitter_test_highlights(void) {
